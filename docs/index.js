 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new E(t,e.slice(1),s).parts}return"@"===n?[new T(t,e.slice(1),i.eventContext)]:"?"===n?[new N(t,e.slice(1),s)]:new x(t,e,s).parts}handleTextExpression(t){return new P(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const R=(t,...e)=>new v(t,e,"html",M)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const Q={};class X extends H{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,s)=>t.reduceRight((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t),s),s=e(t,new Set),i=[];s.forEach(t=>i.unshift(t)),this._styles=i}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?D?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==Q&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return Q}}X.finalized=!0,X.render=(t,s,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const n=i.scopeName,r=O.has(s),o=q&&11===s.nodeType&&!!s.host,a=o&&!B.has(n),l=a?document.createDocumentFragment():s;if(((t,s,i)=>{let n=O.get(s);void 0===n&&(e(s,s.firstChild),O.set(s,n=new P(Object.assign({templateFactory:U},i))),n.appendInto(s)),n.setValue(t),n.commit()})(t,l,Object.assign({templateFactory:z(n)},i)),a){const t=O.get(l);O.delete(l);const i=t.value instanceof g?t.value.template:void 0;j(n,l,i),e(s,s.firstChild),s.appendChild(l),O.set(s,t)}!r&&o&&window.ShadyCSS.styleElement(s.host)};let Y=void 0;const Z=new Float64Array(256),tt=new Float64Array(256),et=new Float64Array(256),st=new class extends EventTarget{constructor(){super(),console.log("Init"),Y=new Accelerometer({frequency:60}),this.initialize(),this.velocity=0,this.evts=[]}pushEvt(t){t._velocity=this.velocity,this.evts.push(t)}initialize(){let t;Y.addEventListener("reading",()=>{void 0!==t&&(Z.copyWithin(1,0,255),Z[0]=Y.z-t,this.velocity*=.3,this.velocity=Math.max(Math.abs(Z[0]),this.velocity),tt.copyWithin(1,0,255),tt[0]=this.velocity,et.copyWithin(1,0,255),et[0]=this.evts.length*this.velocity,this.dispatchEvent(new CustomEvent("sample")),this.evts.forEach(t=>{t._velocity=Math.max(t._velocity,this.velocity),this.dispatchEvent(new CustomEvent("replay-event",{detail:t}))}),this.evts=[]),t=Y.z}),Y.start()}},it=new class extends EventTarget{constructor(){super(),this.effects=new Map,this.ctx=new AudioContext}checkInitAudio(){this._initialized||this.ctx.resume(),this._initialized=!0}async loadEffect(t,e){const s=await fetch(t),i=await s.arrayBuffer();this.ctx.decodeAudioData(i,t=>{this.effects.set(e,t)})}playEffect(t,e){if(!this.effects.has(t))return;const s=this.ctx.createBufferSource();s.buffer=this.effects.get(t);const i=this.ctx.createGain();s.connect(i),i.connect(this.ctx.destination),i.gain.value=e,s.start(0)}};customElements.define("drum-pad",class extends X{constructor(){super(),this.sample="N/A"}static get properties(){return{sample:{type:String}}}static get styles(){return[K`
            .drum {
                border-radius: 50%;
                background: black;
                width: 100%;
        ...
        `}pdown(t){it.checkInitAudio(),st.pushEvt({sample:this.sample})}pup(){}});customElements.define("main-app",class extends X{static get styles(){return[K`
            :host {
                user-select: none;
            }
            ...
            `]}constructor(){super(),this.paintGraph=this.paintGraph.bind(this)}render(){return R`<h1>Sensor Fusion Experiment</h1>
        ...
        `}firstUpdated(){this.graph=this.shadowRoot.querySelector("canvas"),this.ctx=this.graph.getContext("2d"),st.addEventListener("sample",()=>requestAnimationFrame(this.paintGraph)),st.addEventListener("replay-event",t=>{console.log("ReplyEvent",t.detail),it.playEffect(t.detail.sample,.5*Math.log(1+t.detail._velocity))}),it.loadEffect("./assets/audio/xconga_1.ogg","drum1"),it.loadEffect("./assets/audio/xconga_2.ogg","drum2"),it.loadEffect("./assets/audio/xconga_3.ogg","drum3")}plotBuf(t,e){this.ctx.strokeStyle=e,this.ctx.beginPath();let s=100-5*t[0];this.ctx.moveTo(255,s);let i=254,n=1;for(;i>=0&&n<t.length;)s=100-5*t[n],this.ctx.lineTo(i,s),i--,n++;this.ctx.stroke()}paintGraph(){this.ctx.clearRect(0,0,256,200),this.plotBuf(Z,"blue"),this.plotBuf(tt,"green"),this.plotBuf(et,"red")}});
